      ...
      do{
        ...
        switch(ch){
            case 1:
                ...
                Agenda agendaCreata= agenda.creaAgendaDalNome(nomePerAgenda);
                break;
            case 2:
                System.out.println("----------------------------");
            ...
            case 7:
                ...
                agenda.cercaAppuntamentoPerData(agenda1,LocalDate.parse(dataAppuntamento3.format(ld3)));
            ...
            case 8:
                ...
                agenda.cercaAppuntamentoPerNome(agenda,nomeAppuntamento3);
                break;
